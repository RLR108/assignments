...
while(isAlive == true){
    ...
    //isAlive = false;
    if (menuOptions == 1){
        console.log(`Oh Noooo ${playerName}, you've ACTIVATED a BOOBYTRAP, you are now DEAD. GAME OVER!!!! :0 `);
        isAlive = false;
    }
